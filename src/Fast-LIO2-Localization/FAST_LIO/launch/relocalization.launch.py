...
def generate_launch_description():
  ...
  config = os.path.join(
      get_package_share_directory('fast_lio_localization'), 'config', 'fast_lio_relocalization_param.yaml')
  ...
  rviz_config_file = os.path.join(
    get_package_share_directory('fast_lio_localization'), 'rviz', 'loam_livox.rviz')
  start_rviz = Node(
    package='rviz2',
    executable='rviz2',
