...
def transTrajGrid2Map(grid_dim, center, resolution, traj_grid):
    ...
    # The optimizer already returns an absolute body height (ground elevation
    # plus the configured reference height).  The former hard-coded +0.5 m
    # shifted every real map vertically and was then added once more by SCAN.
