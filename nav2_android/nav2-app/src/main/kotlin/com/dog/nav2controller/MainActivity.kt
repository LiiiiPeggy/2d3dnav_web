...
private fun EmptyConnectionScreen(onConnect: () -> Unit) {
    Column(
        ...
        Text("Dog Nav2", style = MaterialTheme.typography.headlineLarge)
        Text(
            text = "控制界面已保存在 App 内；填写机器人地址后连接 Web Bridge。",
    ...
    AlertDialog(
        ...
        text = {
            Column(
                ...
                Text("建图或导航 launch 重启时 App 会保留界面并自动重连。")
                OutlinedTextField(
                    value = host,
                ...
                Row(
                    ...
                    OutlinedTextField(
                        value = httpPort,
                        onValueChange = { httpPort = it; errorMessage = null },
                        label = { Text("HTTP") },
                        singleLine = true,
                    ...
                    OutlinedTextField(
                        value = webSocketPort,
                        onValueChange = { webSocketPort = it; errorMessage = null },
